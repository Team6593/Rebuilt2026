...
public class ShooterSubsystem extends SubsystemBase implements SubsystemInterface{
  ...
  public ShooterSubsystem() {
    ...
    shooter1Configs.Slot0.kS = ShooterInputs.kS;
    ...
    shooter2Configs.Slot0.kP = ShooterInputs.kP;
    shooter2Configs.Slot0.kA = ShooterInputs.kA;
    shooter2Configs.Slot0.kV = ShooterInputs.kV + .005;
    shooter1Configs.Slot0.kS = ShooterInputs.kS;
    shooter2Configs.CurrentLimits.SupplyCurrentLimit = 40;
