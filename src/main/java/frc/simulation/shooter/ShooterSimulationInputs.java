...
public class ShooterSimulationInputs {
    ...
    public static LoggedNetworkNumber shooterKP = new LoggedNetworkNumber("/Tuning/shooterKP", 1.2);
    public static LoggedNetworkNumber shooterKV = new LoggedNetworkNumber("/Tuning/shooterKV", .12);
    public static LoggedNetworkNumber shooterKS = new LoggedNetworkNumber("/Tuning/shooterKA", .07);
