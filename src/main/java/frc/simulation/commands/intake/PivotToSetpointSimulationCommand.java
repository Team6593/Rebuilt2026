...
public class PivotToSetpointSimulationCommand extends Command {

  private IntakeSubsystemSimulation intakeSubsystemSimulation; 

  /** Creates a new PivotToSetpointSimulationCommand. */
  public PivotToSetpointSimulationCommand(IntakeSubsystemSimulation intakeSubsystemSimulation) {
  ...
  public void initialize() {
    intakeSubsystemSimulation.pivotToSetpoint(.3);
  }
